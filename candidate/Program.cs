namespace Candidate
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            SubjectScore[] scores1 = { new SubjectScore(5, "math"), 
                                       new SubjectScore(5, "phyz") };
            SubjectScore[] scores2 = { new SubjectScore(3, "math"), 
                                       new SubjectScore(3, "phyz") };
            SubjectScore[] scores3 = { new SubjectScore(6, "math"),
                                       new SubjectScore(9, "phyz") };
            SubjectScore[] scores4 = { new SubjectScore(7, "math"), 
                                       new SubjectScore(10, "phyz") };
            SubjectScore[] scores5 = { new SubjectScore(4, "math"), 
                                       new SubjectScore(4, "phyz") };
            ...
            foreach (Candidate candidate in candidates)
            {
                uint score = candidate.GetScore("phyz");
                if (maxScore < score)
                    maxScore = score;
            }
